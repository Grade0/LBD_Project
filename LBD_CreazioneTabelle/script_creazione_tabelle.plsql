BEGIN
  ...
  FOR i IN (SELECT ut.table_name
              FROM USER_TABLES ut
		    WHERE ut.table_name!='FILES_ORCL1819') LOOP
...
CREATE SEQUENCE idTipi_seq START WITH 0 MINVALUE 0 INCREMENT BY 1 MAXVALUE 4294967295 CYCLE NOCACHE;
CREATE SEQUENCE idIngredienti_seq START WITH 0 MINVALUE 0 INCREMENT BY 1 MAXVALUE 4294967295 CYCLE NOCACHE;
CREATE SEQUENCE idRifornimenti_seq START WITH 0 MINVALUE 0 INCREMENT BY 1 MAXVALUE 4294967295 CYCLE NOCACHE;
CREATE SEQUENCE idRicette_seq START WITH 0 MINVALUE 0 INCREMENT BY 1 MAXVALUE 4294967295 CYCLE NOCACHE;
