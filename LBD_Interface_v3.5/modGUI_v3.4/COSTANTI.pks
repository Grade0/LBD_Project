...
:root {
  --url-bg-image: url(http://131.114.73.203:8080/apex/utentefinale.files_orcl2021_api.GetImage?p_name=bgbeer2.jpg);
}
...
/*gruppo1*/
profilo1 constant VARCHAR2(500) := 'operazionicataniastasula.profiloBirraio';

/*gruppo2*/
profilo2 constant VARCHAR2(500) := 'GruppoIngredienti.VisualizzaDatiAnagrafici';
