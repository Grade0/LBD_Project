...
procedure AreaDiTesto(nome varchar2, etichetta varchar2,valore varchar2 default '',center boolean default true, lunghezzaMax varchar2 default '', require boolean default false);
