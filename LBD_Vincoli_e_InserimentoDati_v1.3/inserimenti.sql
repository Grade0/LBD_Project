...
---------------------------------- RICETTE--------------------------------
INSERT INTO Ricette (idricetta, idbirraio, nome, istruzioni, metodologie, utilizzabile, ultima_modifica)
VALUES (1, 1, 'Ginger Rye Ale', 'istruzione della ricetta Ginger Rye Ale', 'whole grain', 1, to_date('1/1/2019', 'dd/mm/yyyy'));

INSERT INTO Ricette (idricetta, idbirraio, nome, istruzioni, metodologie, utilizzabile, ultima_modifica)
VALUES (2, 1, 'Pumpking beer', 'istruzione della ricetta Pumpking beer', 'whole grain', 0, to_date('26/11/2019', 'dd/mm/yyyy'));

INSERT INTO Ricette (idricetta, idbirraio, nome, istruzioni, metodologie, utilizzabile, ultima_modifica)
VALUES (3, 2, 'Birra al mango','istruzione della ricetta Birra al mango','extract', 1, to_date('26/09/2018', 'dd/mm/yyyy'));

INSERT INTO Ricette (idricetta, idbirraio, nome, istruzioni, metodologie, utilizzabile, ultima_modifica)
VALUES (4, 3, 'Birra al pepe di Cubebe','istruzione della ricetta Birra al pepe di Cubebe','mixed', 1, to_date('22/07/2020', 'dd/mm/yyyy'));
...
insert into utenti(idutente, uname, pwd, ruolo)
values(1, 'admin', 'admin', 'amministratore');

insert into utenti(idutente, uname, pwd, ruolo)
values(2, 'sysadmin', 'sysadmin', 'amministratore');

insert into utenti(idutente, uname, pwd, ruolo)
values(3, 'prova', 'prova', 'amministratore');